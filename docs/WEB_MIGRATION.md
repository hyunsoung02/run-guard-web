...
| Distance selection | `LocationDistanceScreen.tsx`, `targetDistanceOptions.ts` | 5 / 7 / 10 km | 1~20km, 1km-step accessible slider | Extend the web demo while preserving the 5km default | **IMPLEMENTED** |
